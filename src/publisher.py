    ...
    try:
        ...
        body = {
            "snippet": {
                ...
                "description": f"Automated video report on: {title}.\nGenerated by Autonomous Serverless Pipeline.",
                "tags": ["shorts", "automation", "ai", "finance"],
