...
class PromptEngineerAgent:
    ...
    def engineer_publish_metadata(self, script, topic):
        ...
        system_prompt = (
            ...
            "- youtube_description: Topic summary + 5-8 hashtags, max 500 chars, NO citations\n"
            "- youtube_tags: 5-15 SEO tags including: shorts, finance, market, myth, India\n"
            "- telegram_caption: With emojis + 3-5 hashtags, max 200 chars\n"
            "- instagram_description: With emojis + 10-15 hashtags, max 500 chars\n"
